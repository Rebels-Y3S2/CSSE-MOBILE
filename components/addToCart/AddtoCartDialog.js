  ...
  return (
    <Dialog
      ...
      footer={
        <DialogFooter>
          <DialogButton
            text={constants.ADD_TO_CART_BUTTON_TEXT}
    ...
    >
      <DialogContent>
        <Text>{constants.ADD_TO_CART_SUBTITLE}</Text>
        <View style={styles.amountView}>
          <Text style={styles.amountText}>{amount}</Text>
        </View>
        <View style={styles.amountView}>
          <Button style={styles.btn} title={constants.PLUS_BUTTON} onPress={decrementAmount} />
          <Button style={styles.btn} title={constants.MINUS_BUTTON} onPress={incrementAmount} />
        </View>
      </DialogContent>
    </Dialog>
  )
